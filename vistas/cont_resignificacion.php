...
<div id="page-wrapper" style="margin: 0px;">
  ...
  <div class="row">
    <!-- Campo que contiene el valor del id del modulo para auditoria con el nombre del modulo-->
      ...
      <div class="col-lg-12">
          <h1 class="page-header titleprincipal"><img src="../img/botones/resignificaciononly.png">Resignificación planes de área - <?php echo $proyectoMGen[0]["nombre"] ?></h1>
      </div>
      <!-- /.col-lg-12 -->
    <div class="col-md-9">
          <ol class="breadcrumb migadepan">
            ...
            <li class="active migadepan">Resignificación planes de área </li>
          </ol>
    </div>
      ...
      <div class="col-lg-12">
        ...
        <div class="panel panel-default">
          ...
          <div class="titulohead">
            ...
            <div class="row">
              <div class="col-md-6">
                  <div class="titleprincipal"><h4>Registro de Resignificación planes de área - <?php echo $proyectoMGen[0]["nombre"] ?></h4></div>
              </div>
              <div class="col-md-6 text-right">
                 ...
                 <span class="glyphicon glyphicon-plus"></span>Nuevo Resignificación planes de área</button>
              </div>
            </div>
