...
class talento_humanoController extends talento_humanoDAO
{
    ...
    public function getTablaFuncionarioCargo($pkID_proyectoM, $filtro, $filtro2)
    {
        ...
        $array_opciones = [
            "modulo" => "talento_humano", //nombre del modulo definido para jquerycontrollerV2
            "title"  => "Click Ver Detalles", //etiqueta html title
            "href"   => "detalles_talento_humano.php?id_talento_humano=",
    ...
    public function getTalentoHumanoTitulo($id_talento_humano)
    {
    ...
    public function getTalentoHumanoDatosGen($id_talento_humano)
    {
        ...
        if ($funcionario > 0) {
            ...
            echo '<ul class="list-group">
                          <li class="list-group-item"><strong>Número de Identificación</strong>: ' . $funcionario[0]["documento_funcionario"] . '</li>
                          <li class="list-group-item"><strong>Nombre</strong>: ' . $funcionario[0]["nombre_funcionario"] . ' </li>
                          <li class="list-group-item"><strong>Apellido</strong>: ' . $funcionario[0]["apellido_funcionario"] . '</li>
                          <li class="list-group-item"><strong>Teléfono</strong>: ' . $funcionario[0]["telefono_funcionario"] . '</li>
                          <li class="list-group-item"><strong>Email</strong>: ' . $funcionario[0]["email_funcionario"] . '</li>
                          <li class="list-group-item"><strong>Dirección</strong>: ' . $funcionario[0]["direccion_funcionario"] . '</li>
                        </ul>
                ';
    ...
    public function getArchivosTalentoHumanoId($id_talento_humano)
    {

        $archivosTalentoHumano = $this->getFuncionarioID($id_talento_humano);

        //print_r($archivosTalentoHumano);

        echo "<h3>&nbsp;&nbsp;&nbsp;&nbsp;Archivos</h3>";

        if ($archivosTalentoHumano > 0) {

            for ($i = 0; $i < sizeof($archivosTalentoHumano); $i++) {

                echo '<blockquote>';

                echo '<p><a href="../server/php/files/' . $archivosTalentoHumano[$i]["url_funcionario"] . '" target="_blank"><span class="glyphicon glyphicon-file"></span> ' . $archivosTalentoHumano[$i]["url_funcionario"] . '</a></p>
                            <small><span class="glyphicon glyphicon-comment"></span> ' . $archivosTalentoHumano[$i]["des_archivo"] . '</small>
                        ';
