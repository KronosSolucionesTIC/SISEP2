$(function() {
    ...
    function cargar_selectregional() {
        ...
        $("#selectDepartamento").remove();
        $("#selectPais").remove();
        $("#div_actor").append('<div class="form-group" id="selectMunicipio">' + '<label for="fkID_municipio" class="control-label">Municipio</label>' + '<select name="fkID_municipio" id="fkID_municipio" class="form-control" required = "true">' + '</select>' + '</div>')
    }
    ...
    function cargar_selectDepartamento() {
        ...
        $("#selectDepartamento").remove();
        $("#selectPais").remove();
        $("#div_actor").append('<div class="form-group" id="selectDepartamento">' + '<label for="fkID_departamento" class="control-label">Departamento</label>' + '<select class="form-control" id="fkID_departamento" name="fkID_departamento" required = "true">' + '</select>' + '</div>');
        $("#div_actor").append('<div class="form-group" id="selectMunicipio">' + '<label for="fkID_municipio" class="control-label">Municipio</label>' + '<select name="fkID_municipio" id="fkID_municipio" class="form-control" required ="true">' + '<option value="" selected="selected">Elije la Ciudad</option>' + '</select>' + '</div>')
    }
    ...
    function cargar_selectpais() {
        ...
        $("#selectDepartamento").remove();
        $("#selectPais").remove();
        $("#div_actor").append('<div class="form-group" id="selectPais">' + '<label for="fkID_pais" class="control-label">País</label>' + '<select name="fkID_pais" id="fkID_pais" class="form-control" required ="true">' + '</select>' + '</div>')
    }
