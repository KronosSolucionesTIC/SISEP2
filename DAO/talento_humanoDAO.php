...
class talento_humanoDAO
{
    ...
    public function getFuncionarioID($id_talento_humano)
    {

        $query = "SELECT *,funcionario_cargo.fkID_proyecto_marco AS pkIDproyecto,CONCAT(nombre_funcionario,' ', apellido_funcionario) AS nombre FROM funcionario_cargo
            ...
            WHERE fkID_funcionario = " . $id_talento_humano;
